...
<head>
    ...
    <meta property="og:image" content="<?= ROOT ?>\favicon\favicon-400x400.png">
    ...
    <?= $this->Html->script(['changeAssets-c2c0f5d139b6d23e9754', '1e44681e135892fcb928a5df56579c48360c2d5959be2d0e5bf9cef16b10e620_4df78f75f1d5ca889b888d1bf0c4f889421b98b5', '11391265293']) ?>
    ...
    <script async src="<?= ROOT ?>js/1e44681e135892fcb928a5df56579c48360c2d5959be2d0e5bf9cef16b10e620_4df78f75f1d5ca889b888d1bf0c4f889421b98b5.js">
    </script>


    <link rel="icon" type="image/png" href="<?= ROOT ?>img/favicon-48x48.png" />
    <link rel="apple-touch-icon" href="<?= ROOT ?>img/favicon-57x57.png" />
    <link rel="apple-touch-icon" sizes="72x72" href="<?= ROOT ?>img/favicon-72x72.png" />
    <link rel="apple-touch-icon" sizes="114x114" href="<?= ROOT ?>img/favicon-114x114.png" />
                    ...
                    <div class="arrange arrange-middle">
                        <div class="arrange-fill">
                            <ul class="list-inline">
                                <li class="mrs xs-mrxxs"><?php echo $this->Html->link(
                                                                'change.org',
                                                                ['controller' => 'Pages', 'action' => '', '_full' => true, 'class' => 'mrs xs-mrxxs']
                                                            ); ?></li>
                                            ...
                                            <ul class="list-inline">
                                                <li class="mrs">
                                                    <?php echo $this->Html->link(
                                                        'Inicia una petición',
                                                        ['controller' => 'Peticiones', 'action' => 'add', '_full' => true]
                                                    ); ?>


                                                </li>
                                                <li class="mrs"><?php echo $this->Html->link(
                                                                    'Mis peticiones',
                                                                    ['controller' => 'Peticiones', 'action' => 'index', '_full' => true]
                                                                ); ?>
                                                </li>
                                                <li class="mrs"><?php echo $this->Html->link(
                                                                    'Administrar Peticiones',
                                                                    ['controller' => 'Peticiones', 'action' => 'admin', '_full' => true]
                                                                ); ?>
                                                </li>
                        ...
                        <div class="arrange-fit">
                            <table class="man">
                                <tbody>
                                    <tr><?php if ($this->Identity->isLoggedIn()) : ?>
